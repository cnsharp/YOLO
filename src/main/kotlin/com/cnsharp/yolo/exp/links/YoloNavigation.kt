...
/**
 * Shared, public-API-only navigation helpers reused by the terminal
 * [com.intellij.execution.filters.Filter]s. Keeping them in one place avoids duplicating file-open /
 * type-resolution logic across filters.
 *
