...
/**
 * Regression tests for [scopeProjectSimpleNames] — the gate that decides which type simple names are
 * admitted to the terminal link cache. It must contain ONLY names that truly live in the project's
